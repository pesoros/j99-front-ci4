        ...
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between mt-3">
            ...
            <div class="mb-md-0 mb-4 download">
                ...
                <div class="d-flex flex-lg-row flex-sm-column justify-content-center">
                    <a href="https://play.google.com/store/apps/details?id=com.juragan99trans.id" class="btn btn-gp mb-2 mr-2 mr-sm-0 mr-lg-2 d-flex align-items-center justify-content-center" download>
